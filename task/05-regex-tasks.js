...
function getRegexForIPv4() {
   return new RegExp(/^((0*0*[0-9]|0*[1-9][0-9]|0*1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}(00[0-9]|[0-9]|0[1-9][0-9]|0*1[0-9]{2}|2[0-4][0-9]|25[0-5])$/);
}
...
function getPasswordValidator(minLength) {
   var str = "^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])[a-zA-Z0-9]{"+minLength+",}$"
